Pod::Spec.new do |s|
  ...
  s.version          = "0.2.7"
  s.summary          = "A subclass of UIPageViewController that shows an animated selection bar in the navigation bar that visualizes the swiping back and forth between pages."
  s.description      = <<-DESC
